...
echo "  All services are accessible through http://localhost:3000"
echo ""
echo "Service Endpoints:"
echo "  - Main Website:  http://localhost:3000"
echo "  - Admin Panel:   http://localhost:3000/admin"
echo "  - Scholar Forge: http://localhost:3000/scholars"
echo "  - Admin API:     http://localhost:3000/api (proxied to port 8000)"
echo "  - Scholars API:  http://localhost:8081 (direct access)"
echo ""
echo "Direct Service Ports (for debugging):"
echo "  - Frontend:      3000"
echo "  - Admin Backend: 8000"
echo "  - Scholars API:  8081"
echo "  - Scholar Forge: 4500"
echo ""
