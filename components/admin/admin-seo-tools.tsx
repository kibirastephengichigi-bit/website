    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-display text-2xl font-bold text-slate-900">SEO Optimization Tools</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {isGenerating ? <RefreshCw className="w-3 h-3 mr-1 animate-spin" /> : <FileText className="w-3 h-3 mr-1" />}
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <Button
                    ...
                    disabled={isGenerating}
                  >
                    {isGenerating ? <RefreshCw className="w-3 h-3 mr-1 animate-spin" /> : <ShieldCheck className="w-3 h-3 mr-1" />}
                    {isGenerating ? 'Generating...' : 'Generate'}
                  </Button>
                </div>
              </div>
